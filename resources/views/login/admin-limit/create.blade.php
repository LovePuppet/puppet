                ...
                <form role="form" action="{{URL('admin/limit/create/save')}}" method="post" id="admin_limit_create_form">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="limit_name">权限名</label>
                            <input type="text" class="form-control" id="limit_name" name="limit_name" placeholder="请输入权限名" required>
                        </div>
                        <div class="form-group">
                            <label for="limit_url">权限地址</label>
                            <input type="text" class="form-control" id="limit_url" name="limit_url" placeholder="请输入权限地址" required>
                        </div>
                    </div>
                    <!-- /.box-body -->
