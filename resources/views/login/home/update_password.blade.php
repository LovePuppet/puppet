...
<div class="login-box">
    <div class="login-logo">
        <a href="javascript:void(0);"><b>Puppet</b>修改密码</a>
    </div>
    <div class="login-box-body">
        ...
        <form action="{{URL('admin/update/password/form')}}" method="post" id="update_password_form">
            ...
            <div class="form-group has-feedback">
                <input type="password" id="new_password" name="new_password" class="form-control" placeholder="新密码" required>
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="password" class="form-control" id="repassword" name="repassword" placeholder="确认新密码" required>
                <span class="glyphicon glyphicon-log-in form-control-feedback"></span>
            </div>
            <div class="row">
                <div class="col-xs-4">
                    <button type="submit" class="btn btn-primary btn-block btn-flat">提 交</button>
                </div>
            </div>
        </form>
    </div>
