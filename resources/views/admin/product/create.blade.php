    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                ...
                @endif
                <form role="form" action="{{URL('admin/product/create/save')}}" method="post" id="data_form">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="limit" name="limit" placeholder="请输入额度金额范围">
                        </div>
                        <div class="form-group">
                            <label for="applicants">申请人数</label>
                            <input type="text" class="form-control" id="applicants" name="applicants" placeholder="请输入申请人数">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="reasons" name="reasons" placeholder="请输入推荐理由">
                        </div>
                        <div class="form-group">
