    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                ...
                @endif
                <form role="form" action="{{URL('admin/product/edit/save').'/'.$data['product_id'] }}" method="post" id="data_form">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="category_id">分类<span style="color: red">*</span></label>
                            <select class="form-control" name="category_id">
                                @foreach($categories as $category)
                                <option value="{{ $category['category_id'] }}" @if($data['category_id'] == $category['category_id']) selected @endif>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title" name="title" placeholder="请输入名称" value="{{ $data['title'] }}" required>
                        </div>
                        <div class="form-group">
                            <label for="explain">说明</label>
                            <input type="text" class="form-control" id="explain" name="explain" placeholder="请输入说明" value="{{ $data['explain'] }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="img" name="img" value="{{ $data['img'] }}">
                            <span class="mailbox-attachment-icon has-img">
                                <img src="{{ env('IMAGE_URL').$data['img'] }}" id="show_img_url"/>
                            </span>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="detail_img" name="detail_img" value="{{ $data['detail_img'] }}">
                            <span class="mailbox-attachment-icon has-img">
                                <img src="{{ env('IMAGE_URL').$data['detail_img'] }}" id="show_detail_img_url"/>
                            </span>
                        </div>
                        <div class="form-group">
                            <label for="limit">额度金额范围</label>
                            <input type="text" class="form-control" id="limit" name="limit" placeholder="请输入额度金额范围" value="{{ $data['limit'] }}">
                        </div>
                        <div class="form-group">
                            <label for="applicants">申请人数</label>
                            <input type="text" class="form-control" id="applicants" name="applicants" placeholder="请输入申请人数" value="{{ $data['applicants'] }}">
                        </div>
                        <div class="form-group">
                            <label for="recommend">是否推荐</label>
                            <select class="form-control" id="recommend" name="recommend" style="width:40%;">
                                <option value="2" @if($data['recommend'] == 2) selected @endif>否</option>
                                <option value="1" @if($data['recommend'] == 1) selected @endif>是</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="reasons">推荐理由</label>
                            <input type="text" class="form-control" id="reasons" name="reasons" placeholder="请输入推荐理由" value="{{ $data['reasons'] }}">
                        </div>
                        <div class="form-group">
                            <label for="sort">推荐排序</label>
