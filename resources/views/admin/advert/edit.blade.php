    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                ...
                @endif
                <form role="form" action="{{URL('admin/advert/edit/save').'/'.$data['advert_id'] }}" method="post" id="data_form">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="title">标题<span style="color: red">*</span></label>
                            <input type="text" class="form-control" id="title" name="title" placeholder="请输入标题" value="{{ $data['title'] }}" required>
                        </div>
                        <div class="form-group">
                            <label for="max_amount">最高额度<span style="color: red">*</span></label>
                            <input type="text" class="form-control" id="max_amount" name="max_amount" placeholder="请输入最高额度" value="{{ $data['max_amount'] }}" required>
                        </div>
                        <div class="form-group">
                            <label for="credit_rating">信用等级<span style="color: red">*</span></label>
                            <input type="text" class="form-control" id="credit_rating" name="credit_rating" placeholder="请输入信用等级" value="{{ $data['credit_rating'] }}" required>
                        </div>
                        <div class="form-group">
                            <label for="privilege">解锁特权<span style="color: red">*</span></label>
                            <input type="text" class="form-control" id="privilege" name="privilege" placeholder="请输入特权" value="{{ $data['privilege'] }}" required>
                        </div>
                        <div class="form-group">
                            <label for="success_rate">贷款成功率<span style="color: red">*</span></label>
                            <input type="text" class="form-control" id="success_rate" name="success_rate" placeholder="请输入贷款成功率" value="{{ $data['success_rate'] }}" required>
                        </div>
                        <div class="form-group">
...
var image_domain = '{{ env('FILE_DOMAIN').env('IMAGE_URL') }}';
