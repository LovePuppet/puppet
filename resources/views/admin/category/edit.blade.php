    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                ...
                @endif
                <form role="form" action="{{URL('admin/category/edit/save').'/'.$data['category_id'] }}" method="post" id="data_form">
                    <div class="box-body">
                            ...
                            <select class="form-control" name="fid">
                                ...
                                @foreach($categories as $category)
                                    @if($category['category_id'] != $data['category_id'])
                                        @if($data['fid'] == $category['category_id'])
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="category_name" name="category_name" placeholder="请输入名称" value="{{ $data['category_name'] }}" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="icon_url" name="icon_url" value="{{ $data['icon_url'] }}">
                            <span class="mailbox-attachment-icon has-img">
                                <img src="{{ env('IMAGE_URL').$data['icon_url'] }}" id="show_img_url"/>
                            </span>
                        </div>
                        <div class="form-group">
