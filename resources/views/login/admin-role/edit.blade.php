                ...
                <form role="form" action="{{URL('admin/role/edit/save').'/'.$data['admin_role_id'] }}" method="post" id="admin_role_edit_form">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="role_name">账号</label>
                            <input type="text" class="form-control" id="role_name" name="role_name" value="{{ $data['role_name'] }}" placeholder="请输入角色名" required>
                        </div>
                        <div class="form-group">
                            <label for="limits_ids">密码</label>
